...
WorkshopLM generated this external-use candidate from two shareable sources:
...
- `chapter-launch-brief.pdf` — five-slide 16:9 review export produced by LibreOffice from the PowerPoint file.
- `chapter-launch-brief.html` — responsive in-product preview with exact source locators embedded in the citation elements.
- `preview-01.png` through `preview-05.png` — rendered review images from the PowerPoint round trip.
- `contact-sheet.png` — the five-slide cold-review sequence on one page.
