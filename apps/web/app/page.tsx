...
type PersistedWorkshop = {
  ...
  storyboard: { version: number; stale: boolean; panels: { id: string; title: string; narration: string; durationSeconds: number; imagePanelId?: string; imagePanelVersion?: number; approved: boolean; stale: boolean }[] };
