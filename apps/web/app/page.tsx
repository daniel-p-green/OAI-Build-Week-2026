...
export default function WorkshopPage() {
  ...
  async function uploadPdf() {
    ...
    const body = new FormData(); body.set("action", "ingestPdfUpload"); body.set("file", sourceFile);
