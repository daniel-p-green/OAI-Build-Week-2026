...
import { analyzeWebsiteStyle, applyMapOperation, applyStyleLibrary, applyWorkshopAction, approveSketch, approveVisualDna, beginWebsiteStyleAnalysis, cancelVideoRender, captureFallbackTranscript, createImageBatch, createSketch, createVisualDna, createWorkshop, dismissWorkshopOrientation, extractWorkshopCandidates, generateAssetPlan, generateOutput, generateStoryboard, ingestPdfFile, ingestSource, ingestUrl, listStyleLibrary, listWorkshopSummaries, lockManualStyle, lockWebsiteStyle, readWorkshopState, recordOutputFailure, runWebsiteStyleAnalysis, selectImagePanelForRegeneration, selectWorkshop, sendConversationMessage, setActiveSourceScope, syncMapCanvas, type CanvasNodePatch, type ManualStyleInput, type RealtimeCaptureEvidence, type SourceIngestion, type WorkshopOnboarding, type WorkshopOutcome, undoMapOperation, updateStoryboardPanel, updateWorkshopOnboarding } from "../../../../worker/src/workshop-service";
...
type RequestBody = { action?: Action; workshopId?: string; styleLibraryId?: string; title?: string; source?: SourceIngestion; text?: string; capture?: RealtimeCaptureEvidence; toolCall?: ExecuteWorkshopToolInput; providerEvent?: WorkshopProviderToolEvent; url?: string; filePath?: string; permission?: "private" | "sanitized" | "shareable"; sourceIds?: string[]; panelId?: string; operation?: unknown; canvasNodes?: CanvasNodePatch[]; outputType?: "deck" | "infographic"; manualStyle?: ManualStyleInput; intentProfile?: ManualStyleInput["intentProfile"]; onboardingStep?: WorkshopOnboarding["step"]; outcome?: WorkshopOutcome; orientation?: "map" | "outputs"; panel?: { id: string; title: string; narration: string; durationSeconds: number } };
