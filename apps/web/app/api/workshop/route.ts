...
type RequestBody = { action?: Action; workshopId?: string; styleLibraryId?: string; title?: string; source?: SourceIngestion; text?: string; capture?: RealtimeCaptureEvidence; toolCall?: ExecuteWorkshopToolInput; url?: string; filePath?: string; permission?: "private" | "sanitized" | "shareable"; sourceIds?: string[]; panelId?: string; operation?: unknown; canvasNodes?: CanvasNodePatch[]; outputType?: "deck" | "infographic"; manualStyle?: ManualStyleInput; intentProfile?: ManualStyleInput["intentProfile"]; onboardingStep?: WorkshopOnboarding["step"]; outcome?: WorkshopOutcome; orientation?: "map" | "outputs"; panel?: { id: string; title: string; narration: string; durationSeconds: number } };
