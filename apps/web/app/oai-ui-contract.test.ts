...
describe("official Apps in ChatGPT UI implementation", () => {
  ...
  it("keeps internal product language out of visible copy", () => {
    ...
    for (const required of ["Approve brief", "Choose style", "Saved styles", "Use saved style", "Website", "Set manually", "Client pitch", "Board presentation", "Team workshop", "Add brand details", "Use this style", "Save new version", "How WorkshopLM works", "Create outputs", "Update outputs", "Review storyboard", "Sourced claim", "sourced claims", "Sources behind this brief", "Show source", "Sources in this output", "Select a claim to see the exact source text", "Show on map", "Image set", "Audio Overview", "Save script", "Create audio", "Download audio", "AI-generated voice", "Voice transcript", "Source excerpt", "Ready for review", "Create video", "View video", "Download PowerPoint", "Open preview", "Open video", "Up to date", "Needs update"]) expect(page).toContain(required);
