...
The published 2:39 demo at `outputs/demo-film-final/workshoplm-demo.mp4` is preserved as historical submission evidence, but it is not the approved final film. Daniel rejected its narration mix and editorial quality after publication. A replacement remains local until it passes owner review; no corresponding public surface or release may be changed automatically.
