...
Last updated: 2026-07-16 06:48 CT
...
- The current editable Presentation now carries the approved GPT Image 2 hero into both its HTML preview and PowerPoint instead of leaving the visual family beside the deck. Deck Version 4 records the exact `image-batch-v1` / `image-panel-1` Version 1 / SHA-256 dependency; replacing that panel marks the Presentation `Needs update`. A LibreOffice round trip caught and repaired the non-portable `SF Pro system stack` alias, and the accepted five-slide 16:9 review now uses Arial, quiet citations, and the generated cover visual without another provider request. Evidence is `artifacts/live-review/presentation-v4/`.
