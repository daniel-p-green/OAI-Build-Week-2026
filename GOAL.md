...
Last updated: 2026-07-15 21:51 CT
...
- [ ] Rebuild WorkshopLM as one responsive three-column workbench with persistent/collapsible Sources on the left, WorkshopLM Conversation or the selected work object in the center, and persistent/collapsible Production progress on the right.
  - 2026-07-15 Phase 1: stable desktop and compact geography is implemented. Sources, the current object, Production state, and one next action stay visible together; rail collapse controls and the in-product Conversation remain open.
...
- [ ] Keep source selection, the claim under review, and its exact evidence excerpt visible together. Changing source scope must reveal affected downstream work before the user loses context.
