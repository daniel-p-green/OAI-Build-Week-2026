...
The current phase is **submitted, with the public demo rejected and external surfaces frozen pending Daniel's review**. The core product, founder-authorized connected Workshop, improved Product Story Site, portable judge release, Devpost submission, public YouTube playback, and X announcement exist, but the published 2:39 film is not owner-approved: Daniel identified echo, excessive music ducking, and broader editorial problems. No YouTube, X, Devpost, release, or other public change may be made without explicit human review and approval. A product-first local replacement now exists for review; it is not a new public master.
...
- [x] **Verify and submit.** The final-film verifier and complete submission-packet verifier pass against the 2:39 master. The public YouTube upload at `https://youtu.be/gwi_q6X1i5g` passed both YouTube checks and returned cookie-free playability status `OK`. Devpost submission `1108961` reports `Submitted`; an anonymous read of `https://devpost.com/software/workshoplm` returns the final tagline, why-first description, and embedded YouTube ID. X confirmed the announcement at `https://x.com/dgrreen/status/2079387902304243747`. The portable release tag is `build-week-submission-final-2026-07-21`.
