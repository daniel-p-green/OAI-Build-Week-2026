...
| Final self-produced submission | Provider-backed final Devpost copy, README narrative, deck, thumbnails, Storyboard, narration, and video in one verified Output set | Describe the current 16-asset set as `partial` and recorded-fixture based. |
