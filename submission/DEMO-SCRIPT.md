...
The current draft is 52.2 seconds of screen-only fixture footage, not the final submission video. It proves the current workbench and deterministic no-credential path. The rough-cut builder combines it with separately verified Codex doorway and provider media inserts.
