...
const storyboard = Storyboard.parse({ id: "storyboard-v1", versionId: "story-version-v1", workshopId: "workshop-build-week", approvedAt: "2026-07-13T23:00:00.000Z", staleState: "current", panels: [{ id: "panel-1", purpose: "Show proof", claimIds: ["claim-1"], evidence: [{ claimId: "claim-1", sourceId: "source-1", chunkId: "chunk-1", locator: "Fixture · chunk 01" }], voiceover: "AI-generated narration: raw thinking becomes grounded work.", onScreenText: "Capture → Map → Brief → Create", durationSeconds: 4, composition: "editorial evidence map", visualDnaVersionId: "dna-v1", transition: "cut", approved: true, staleState: "current" }] });
...
if (!renderDeck(brief).includes("Judges see") || !renderInfographic(brief).includes("Grounded infographic")) throw new Error("production render missing content");
