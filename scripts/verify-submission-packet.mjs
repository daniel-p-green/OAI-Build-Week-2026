...
assert(packageJson.scripts?.["submission:fixture:verify"] === "pnpm demo:e2e && pnpm submission:build && pnpm submission:verify && pnpm demo:film:sample && pnpm demo:film:verify-sample && pnpm submission:packet:verify", "The fixture verification command no longer preserves the required reset, package, provenance-rebind, and packet order.");
