...
export const StoryboardPanel = z.object({ id: z.string().min(1), purpose: z.string().min(1), claimIds: z.array(ClaimId), voiceover: z.string().min(1), onScreenText: z.string(), durationSeconds: z.number().positive(), composition: z.string().min(1), visualDnaVersionId: VersionId, transition: z.string().min(1), approved: z.boolean(), staleState: StaleState }).strict();
