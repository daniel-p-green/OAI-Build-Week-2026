...
const infographicRole = (layout: SlideLayout, index: number) => layout === "proof" ? "Evidence" : layout === "recommendation" ? "Recommendation" : layout === "decision" ? "Decision" : layout === "sequence" ? "Path" : layout === "plan" ? "Plan" : index === 0 ? "Key insight" : "Context";
const infographicTone = (layout: SlideLayout, index: number) => layout === "recommendation" || layout === "decision" ? "recommendation" : layout === "proof" ? "evidence" : index === 0 ? "insight" : "context";
...
function shell(title: string, brief: RenderBrief, body: string) {
  ...
  *{box-sizing:border-box}html{background:#e8e8e5}body{margin:0;color:var(--ink);font-family:var(--body);background:#e8e8e5}.deck{display:grid;gap:28px;padding:28px}.slide{position:relative;overflow:hidden;width:min(1280px,calc(100vw - 56px));aspect-ratio:16/9;margin:auto;background:var(--paper);padding:6.4%;box-shadow:0 18px 52px rgba(0,0,0,.12)}.slide:after{content:attr(data-page);position:absolute;right:4.8%;bottom:4%;font-size:11px;color:var(--muted)}.cover{display:flex;flex-direction:column;justify-content:flex-end;background:var(--ink);color:var(--paper)}.cover:before{content:'';position:absolute;width:38%;aspect-ratio:1;border-radius:50%;background:var(--accent);right:-10%;top:-25%}.cover.has-visual:before{display:none}.cover-visual{position:absolute;right:4.8%;top:8%;width:42%;height:auto;max-height:78%;aspect-ratio:1;object-fit:contain}.cover.has-visual .title{max-width:52%}.cover.has-visual .subtitle{max-width:48%}.brand-logo{position:absolute;left:6.4%;top:6.4%;width:auto;height:64px;max-width:160px;object-fit:contain}.eyebrow{position:relative;color:var(--accent);font:700 11px/1 var(--body);letter-spacing:.14em;text-transform:uppercase}.cover .eyebrow{color:var(--paper);opacity:.72}.title{position:relative;font:500 clamp(38px,5.1vw,76px)/.98 var(--heading);letter-spacing:-.04em;max-width:88%;margin:22px 0}.subtitle{position:relative;max-width:68%;font-size:18px;line-height:1.45;color:color-mix(in srgb,var(--paper) 72%,transparent)}.slide h2{font:500 clamp(28px,3.7vw,56px)/1.02 var(--heading);letter-spacing:-.035em;margin:18px 0 28px;max-width:86%}.slide p{font-size:clamp(16px,1.55vw,23px);line-height:1.45;margin:0}.statement{display:flex;flex-direction:column;justify-content:center}.statement h2{font-size:clamp(38px,4.6vw,70px)}.statement .body{max-width:68%;border-left:5px solid var(--accent);padding-left:24px}.statement.is-sparse h2{max-width:92%;font-size:clamp(44px,5.3vw,78px)}.split{display:grid;grid-template-columns:30% 1fr;gap:8%;align-items:center;background:linear-gradient(90deg,color-mix(in srgb,var(--accent) 8%,var(--paper)) 0 31%,var(--paper) 31%)}.split .number{font:500 clamp(100px,15vw,220px)/.8 var(--heading);color:var(--accent);letter-spacing:-.08em}.split.is-sparse h2{max-width:94%;font-size:clamp(34px,4vw,62px)}.proof{display:grid;grid-template-columns:1fr 36%;gap:8%;align-items:end}.proof .proof-card{align-self:stretch;border-radius:4px;background:var(--ink);color:var(--paper);padding:30px;display:flex;flex-direction:column;justify-content:flex-end}.proof .proof-card strong{font:500 26px/1.15 var(--heading)}.proof.has-items{grid-template-columns:minmax(0,1fr) 42%;align-items:center}.proof-item-grid{display:grid;gap:14px;counter-reset:proof-item}.proof-item{counter-increment:proof-item;display:grid;grid-template-columns:38px 1fr;align-items:center;min-height:112px;padding:20px 22px;background:var(--ink);color:var(--paper);font:500 clamp(15px,1.35vw,20px)/1.28 var(--heading)}.proof-item:before{content:counter(proof-item,decimal-leading-zero);color:var(--accent);font:700 11px/1 var(--body);letter-spacing:.1em}.proof.is-sparse>div{align-self:center}.proof.metrics{display:flex;flex-direction:column;justify-content:center;align-items:stretch}.metric-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:5%;margin:36px 0 30px}.metric-grid[data-count="3"]{grid-template-columns:repeat(3,minmax(0,1fr));gap:3.5%}.metric{border-top:2px solid var(--accent);padding-top:18px}.metric strong{display:block;font:500 clamp(64px,8vw,120px)/.85 var(--heading);letter-spacing:-.065em;color:var(--ink)}.metric-grid[data-count="3"] .metric strong{font-size:clamp(54px,6.4vw,96px)}.metric span{display:block;margin-top:12px;color:var(--muted);font-size:14px;text-transform:uppercase;letter-spacing:.12em}.proof.metrics .body{max-width:86%;font-size:clamp(15px,1.35vw,20px)}.recommendation{background:var(--accent);color:var(--accent-foreground);display:flex;flex-direction:column;justify-content:center}.recommendation .eyebrow,.recommendation .cite{color:var(--accent-foreground)}.recommendation h2{font-size:clamp(40px,5vw,76px);max-width:92%}.recommendation.is-sparse h2{font-size:clamp(46px,5.4vw,82px)}.cite{position:absolute;left:6.4%;bottom:4%;max-width:78%;font-size:10px!important;line-height:1.3!important;color:var(--muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.infographic{position:relative;width:min(1280px,calc(100vw - 48px));aspect-ratio:16/9;margin:24px auto;background:var(--paper);padding:5.2% 6%;box-shadow:0 18px 52px rgba(0,0,0,.12)}.infographic:before{content:'';position:absolute;inset:0 auto 0 0;width:18px;background:var(--accent)}
  ...
  .infographic .title{margin:16px 0 30px;font-size:clamp(32px,3.45vw,52px)}.infographic-board{display:grid;grid-template-columns:repeat(12,minmax(0,1fr));grid-template-rows:200px minmax(190px,1fr);gap:18px;min-height:445px}.infographic-card{position:relative;min-width:0;overflow:hidden;padding:22px 24px 34px;border:1px solid var(--line);background:color-mix(in srgb,var(--accent) 4%,var(--paper))}.infographic-card:nth-child(1){grid-column:1/8;grid-row:1}.infographic-card:nth-child(2){grid-column:8/13;grid-row:1}.infographic-card:nth-child(3){grid-column:1/5;grid-row:2}.infographic-card:nth-child(4){grid-column:5/13;grid-row:2}.infographic-board[data-count="3"] .infographic-card:nth-child(3){grid-column:1/13}.infographic-board[data-count="2"]{grid-template-rows:minmax(300px,1fr)}.infographic-board[data-count="2"] .infographic-card:nth-child(1){grid-column:1/7;grid-row:1}.infographic-board[data-count="2"] .infographic-card:nth-child(2){grid-column:7/13;grid-row:1}.infographic-board[data-count="1"]{grid-template-rows:minmax(360px,1fr)}.infographic-board[data-count="1"] .infographic-card:nth-child(1){grid-column:1/13;grid-row:1}.infographic-card-header{display:flex;align-items:center;gap:10px;margin-bottom:18px}.infographic-card-role{font:700 9px/1 var(--body);letter-spacing:.14em;text-transform:uppercase}.infographic-card .block-number{display:grid;place-items:center;width:26px;height:26px;border-radius:50%;background:var(--accent);color:var(--accent-foreground);font:700 8px/1 var(--body);letter-spacing:.08em}.infographic-card h2{max-width:96%;margin:0 0 12px;font:500 clamp(19px,1.9vw,29px)/1.06 var(--heading);letter-spacing:-.03em}.infographic-card>p:not(.cite){max-width:92%;margin:0;color:var(--muted);font-size:clamp(12px,1.02vw,15px);line-height:1.42}.infographic-card .cite{left:24px;bottom:14px;max-width:calc(100% - 48px)}.infographic-card[data-tone="insight"]{border-top:5px solid var(--accent)}.infographic-card[data-tone="evidence"]{background:var(--ink);color:var(--paper);border-color:var(--ink)}.infographic-card[data-tone="evidence"] .block-number{background:var(--accent)}.infographic-card[data-tone="evidence"]>p:not(.cite),.infographic-card[data-tone="evidence"] .cite{color:color-mix(in srgb,var(--paper) 64%,transparent)}.infographic-card[data-tone="recommendation"]{background:var(--accent);color:var(--accent-foreground);border-color:var(--accent)}.infographic-card[data-tone="recommendation"] .block-number{background:var(--accent-foreground);color:var(--accent)}.infographic-card[data-tone="recommendation"]>p:not(.cite),.infographic-card[data-tone="recommendation"] .cite{color:var(--accent-foreground)}.infographic-card[data-layout="sequence"]{grid-column:1/13!important}.infographic-card .infographic-sequence{margin-top:22px}.infographic-card .infographic-sequence span{background:color-mix(in srgb,var(--accent) 5%,var(--paper))}.infographic-card[data-tone="recommendation"] .infographic-sequence span{border-color:var(--accent-foreground);color:var(--accent-foreground)}.infographic-card[data-tone="recommendation"] .infographic-sequence span:before,.infographic-card[data-tone="recommendation"] .infographic-sequence span:not(:last-child):after{color:var(--accent-foreground)}.infographic.intent-board-deck .infographic-card{border-radius:0}.infographic.intent-internal-workshop .infographic-card{border-width:2px}
  .infographic-board{grid-template-rows:220px minmax(210px,1fr);min-height:448px}.infographic-card{display:flex;flex-direction:column;padding:18px 20px 16px}.infographic-card-header{margin-bottom:12px}.infographic-card h2{margin-bottom:8px}.infographic-card>p:not(.cite){line-height:1.35}.infographic-card .cite{position:static;left:auto;bottom:auto;max-width:100%;margin-top:auto;padding-top:10px}
  ...
  @media(max-width:720px){.infographic-board,.infographic-board[data-count]{display:grid;grid-template-columns:1fr;grid-template-rows:auto;min-height:0}.infographic-card,.infographic-board .infographic-card:nth-child(n){grid-column:1!important;grid-row:auto!important;min-height:190px}.infographic-card h2{font-size:24px}.infographic-card .infographic-sequence{grid-template-columns:1fr;gap:8px}.infographic-card .infographic-sequence span:not(:last-child):after{display:none}}
...
export function renderInfographic(brief: RenderBrief): string {
  ...
  const blocks = sourceBlocks.map((block, index) => {
    ...
    const role = infographicRole(layout, index);
    const tone = infographicTone(layout, index);
    ...
    return `<article class="infographic-card" data-layout="${layout}" data-tone="${tone}"><header class="infographic-card-header"><span class="block-number">${String(index + 1).padStart(2, "0")}</span><span class="infographic-card-role">${escapeHtml(role)}</span></header><h2>${escapeHtml(block.heading)}</h2>${body}<p class="cite"${citationData(block)}>${escapeHtml(citationText(block))}</p></article>`;
  }).join("\n");
  return shell(`${brief.workshopTitle} infographic`, brief, `<main class="infographic ${intentClass(brief)}" data-intent="${intentProfile(brief)}"><div class="eyebrow">${escapeHtml(infographicLabel(brief))}</div><h1 class="title">${escapeHtml(brief.workshopTitle)}</h1><section class="infographic-board" data-count="${sourceBlocks.length}" aria-label="Grounded decision graphic">${blocks}</section></main>`);
}
...
export async function writeEditableInfographic(path: string, brief: RenderBrief): Promise<void> {
  ...
  const positions = blocks.length >= 4
    ? [{ x: 0.72, y: 1.84, w: 7.38, h: 2.12 }, { x: 8.34, y: 1.84, w: 4.29, h: 2.12 }, { x: 0.72, y: 4.12, w: 4.2, h: 2.34 }, { x: 5.16, y: 4.12, w: 7.47, h: 2.34 }]
    : blocks.length === 3
      ? [{ x: 0.72, y: 2.12, w: 7.38, h: 1.72 }, { x: 8.34, y: 2.12, w: 4.29, h: 1.72 }, { x: 0.72, y: 4.06, w: 11.91, h: 2.26 }]
      : blocks.length === 2
        ? [{ x: 0.72, y: 2.12, w: 5.82, h: 4.2 }, { x: 6.78, y: 2.12, w: 5.85, h: 4.2 }]
        : [{ x: 0.72, y: 2.12, w: 11.91, h: 4.2 }];
  blocks.forEach((block, index) => {
    const position = positions[index]!;
    const layout = slideLayout(block, index, blocks.length);
    const tone = infographicTone(layout, index);
    const foreground = tone === "recommendation" ? pptxColor(accentForeground(brief)) : tone === "evidence" ? paper : ink;
    const fill = tone === "recommendation" ? accent : tone === "evidence" ? ink : paper;
    const line = tone === "recommendation" ? accent : tone === "evidence" ? ink : accent;
    ...
    slide.addShape(pptx.ShapeType.rect, { ...position, fill: { color: fill, transparency: tone === "context" ? 2 : 0 }, line: { color: line, transparency: tone === "context" ? 60 : 0, width: tone === "insight" ? 1.5 : 0.8 } });
    if (tone === "insight") slide.addShape(pptx.ShapeType.rect, { x: position.x, y: position.y, w: position.w, h: 0.06, fill: { color: accent }, line: { color: accent, transparency: 100 } });
    const badgeFill = tone === "recommendation" ? pptxColor(accentForeground(brief)) : accent;
    const badgeText = tone === "recommendation" ? accent : pptxColor(accentForeground(brief));
    slide.addShape(pptx.ShapeType.ellipse, { x: position.x + 0.24, y: position.y + 0.17, w: 0.28, h: 0.28, fill: { color: badgeFill }, line: { color: badgeFill, transparency: 100 } });
    slide.addText(String(index + 1).padStart(2, "0"), { x: position.x + 0.24, y: position.y + 0.255, w: 0.28, h: 0.1, fontFace: bodyFont(brief), fontSize: 4.8, bold: true, color: badgeText, charSpacing: 0.5, margin: 0, align: "center", valign: "mid" });
    slide.addText(infographicRole(layout, index).toUpperCase(), { x: position.x + 0.64, y: position.y + 0.255, w: Math.max(position.w - 0.9, 0.5), h: 0.12, fontFace: bodyFont(brief), fontSize: 6.5, bold: true, color: foreground, charSpacing: 1.1, margin: 0 });
    const headingY = position.y + 0.58;
    const headingHeight = position.h > 3 ? 1.34 : 0.72;
    const bodyY = headingY + headingHeight + 0.08;
    const citationY = position.y + position.h - 0.24;
    const bodyHeight = Math.max(citationY - bodyY - 0.1, 0.3);
    slide.addText(primaryText, { x: position.x + 0.24, y: headingY, w: position.w - 0.48, h: headingHeight, fontFace: headingFont(brief), fontSize: position.w > 7 ? 19 : position.w < 4.5 ? 14 : 17, color: foreground, margin: 0, breakLine: false, fit: "shrink", valign: "top" });
    if (layout === "sequence" && block.items?.length) {
      const steps = block.items.slice(0, 4); const stepGap = 0.12; const stepWidth = (position.w - 0.48 - stepGap * (steps.length - 1)) / steps.length;
      steps.forEach((item, itemIndex) => {
        const stepX = position.x + 0.24 + itemIndex * (stepWidth + stepGap);
        slide.addShape(pptx.ShapeType.rect, { x: stepX, y: position.y + position.h - 1.28, w: stepWidth, h: 0.62, fill: { color: tone === "recommendation" ? foreground : accent, transparency: tone === "recommendation" ? 82 : 90 }, line: { color: tone === "recommendation" ? foreground : accent, transparency: 25 } });
        slide.addText(item, { x: stepX + 0.1, y: position.y + position.h - 1.08, w: stepWidth - 0.2, h: 0.22, fontFace: headingFont(brief), fontSize: 9.5, color: foreground, margin: 0, fit: "shrink", valign: "mid", align: "center" });
      });
    } else if (supportingText) slide.addText(supportingText, { x: position.x + 0.24, y: bodyY, w: position.w - 0.48, h: bodyHeight, fontFace: bodyFont(brief), fontSize: position.w < 4.5 ? 8.5 : 10, color: foreground, transparency: tone === "recommendation" ? 8 : 28, margin: 0, breakLine: false, fit: "shrink", valign: "top" });
    slide.addText(citationText(block), { x: position.x + 0.24, y: citationY, w: position.w - 0.48, h: 0.1, fontFace: bodyFont(brief), fontSize: 5.2, color: foreground, transparency: tone === "recommendation" ? 10 : 42, margin: 0, breakLine: false, fit: "shrink" });
  });
